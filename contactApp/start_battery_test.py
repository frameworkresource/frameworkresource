...
parser.add_argument('-a', '--apps', type=str, help='Comma separated list of apps to execute', default='native,flutter,capacitor,react')
    ...
    for app in apps:
        ...
        for interaction in interactions:
            ...
            if interaction[1]:
                ...
                adb.dump_meminfo(app["pkg"])
                adb.pull_data("./data/local/tmp/battery.txt", "./data/battery_{}_{}_{}_{}.txt".format(device, app["name"], interaction[0], n))
                adb.pull_data("./data/local/tmp/meminfo.txt", "./data/meminfo_{}_{}_{}_{}.txt".format(device, app["name"], interaction[0], n))
