...
// 21/05/2022
// https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/nbody-dartexe-6.html
...
void runNBody(final int n, IOSink writer) {
  offsetMomentum();
  writer.writeln(energy().toStringAsFixed(9));
  for (int i = 0; i < n; i++) {
    advance(0.01);
  }
  writer.writeln(energy().toStringAsFixed(9));
