...
// 21/05/2022
// https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/mandelbrot-dartexe-3.html
...
void runMandelBrot(final int h, IOSink writer) {
  int w = h;
